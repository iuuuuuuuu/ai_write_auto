...
<template>
  <div class="space-y-4">
    <div class="card-surface p-3 space-y-3">
      ...
      <div
        class="grid gap-3 rounded-md border border-(--ui-border)/50 p-2"
        :class="
      ...
      >
        ...
        <div
          v-if="backupSettings.scheduleEnabled"
          class="sm:col-span-full flex flex-wrap items-center gap-2 border-t border-(--ui-border)/40 pt-2"
        >
      ...
      <div
        class="flex items-center justify-between rounded-md border border-(--ui-border)/50 px-3 py-2"
      >
      ...
      <div class="rounded-md border border-(--ui-border)/50">
        <div
          class="flex items-center justify-between gap-2 border-b border-(--ui-border)/50 px-2 py-1.5"
        >
      ...
      >
        ...
        <div
          ...
          class="mt-2 overflow-hidden rounded border border-(--ui-border)/50"
        >
          <div class="flex items-center gap-2 px-2 py-1.5 bg-(--ui-bg-muted)/50">
