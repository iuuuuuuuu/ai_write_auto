...
export default defineEventHandler(async (event) => {
  ...
  if (data.description !== undefined) foreshadowing.description = data.description
  if (data.status !== undefined) foreshadowing.status = data.status
  if (data.resolvedAtChapter !== undefined) foreshadowing.resolvedAtChapter = data.resolvedAtChapter
