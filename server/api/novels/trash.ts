...
export default defineEventHandler(async (event) => {
  ...
  if (method === 'DELETE') {
    ...
    if (type === 'novel') {
      ...
      await em.nativeDelete('CharacterStateSnapshot', { novel: id })
      await em.nativeDelete('CharacterStateChange', { novel: id })
    ...
    if (type === 'chapter') {
      ...
      await em.nativeDelete('CharacterStateSnapshot', { chapter: id })
      await em.nativeDelete('CharacterStateChange', { chapter: id })
